  ...
  const policies: PolicyChange[] = [
    {
      ...
      impact: "Defined the rules and policies for Twitter users. See the full terms at <a href='https://help.twitter.com/en/rules-and-policies/twitter-terms-of-service' target='_blank' rel='noopener noreferrer' className='text-indigo-600 underline'>help.twitter.com/en/rules-and-policies/twitter-terms-of-service</a>"
    },
    {
      date: "January 2023",
